# Generated by Django 3.1.6 on 2021-02-05 08:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_deate', models.DateField(blank=True, null=True, verbose_name='Died')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='English, French, Korean..', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre fot this book', to='catalog.Genre'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
